...
parser.add_argument(
    ...
    type=str,
    default='NVTabular',
    choices=['NVTabular', 'PyTorch', 'FastAI'],
...
parser.add_argument(
    ...
    choices=['time_only_dl', 'time_training'],
...
if args.preprocess=='yes':
    _run_notebook('/tmp/', 'benchmark-preprocess-pyt.ipynb', lambda line: replace_lines(line, replaces))

replaces.append(
    ["DL_TYPE = 'NVTabular'", "DL_TYPE = '" + args.dl_type + "'"]
)
replaces.append(
...
print(replaces)
_run_notebook('/tmp/', 'benchmark-training-pyt.ipynb', lambda line: replace_lines(line, replaces))
